...
3. **#62** — Coffee runtime **dropped** (Option 2); Babel 5 still present (Option 3/4 later)  
...
- `CHEVRON_DISABLE_LEGACY_TRANSPILE=1` — refuse Coffee (already removed) / Babel-5 compile-cache  
