...
- Defer heavy bundled packages (`github`, `markdown-preview`, `settings-view`, …) until after first paint. Linux `setup-window:end` **1582 → 1103 ms**. Tree-view / tabs / welcome still preload.
