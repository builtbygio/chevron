...
- `script/ci/script-fossils.test.js` asserted these fossils must **stay**. Each was kept on a premise that has since expired, so the guard now asserts they are gone and records why.
