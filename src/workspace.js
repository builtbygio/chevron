...
// `chevron://` is the only product URI scheme. The `atom://` alias and the
// alternate-spelling opener fallback were removed in Wave 4, once a sweep of
// all 94 owned pins found zero shipped `atom://` emitters.
