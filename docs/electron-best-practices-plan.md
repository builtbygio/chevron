...
**Related:** `docs/security-phase-n.md`, `docs/security-phase-n5.md`, `docs/package-node-policy.md`, `docs/remote-ipc-inventory.md`, `docs/security-threat-model.md`  
**Handoff:** `GROK.md`  
...
`core.restrictCommunityPackageRequires` default **true**; env/config escape hatch. Core + bundled unrestricted. See `docs/package-node-policy.md`.
...
**Deliverable for this plan:** inventory of remaining sync channels lives in [`docs/remote-ipc-inventory.md` §11](./remote-ipc-inventory.md). Do not block releases on wholesale conversion.
...
Blocked on natives in `src/preload-natives.js`. Authoritative notes: `docs/security-phase-n.md` / `security-phase-n5.md`.
