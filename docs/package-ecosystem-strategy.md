...
**Related:** [package-ownership-inventory.md](./package-ownership-inventory.md), [REBRANDING.md](./REBRANDING.md), [security-phase-s-package-host.md](./security-phase-s-package-host.md), [cpm-design.md](./cpm-design.md)
...
- Forks under `builtbygio/<name>` modernized with [owned-package-modernization-checklist.md](./owned-package-modernization-checklist.md)  
...
When the owner is happy with **base Chevron** (core APIs, owned catalog, security defaults), resume **package host v2** from [security-phase-s-package-host.md](./security-phase-s-package-host.md):
