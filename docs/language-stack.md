...
**Remaining** (4 pins, 21 files; next is `language-git`):

| Pin | `.cson` files |
|-----|--------------:|
| `language-ruby-on-rails` | 6 |
| `language-git`, `language-objective-c`, `language-sass` | 5 each |
