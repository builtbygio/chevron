...
**Status:** H2 PR 13 catalog + PR 13b stream. YAML ported. This is the exception list, not a promise that first-mate dies.  
**Owner:** `builtbygio`  
...
|---------|-------|----------|
| `language-xml` | builtbygio | Markup sibling of already-ported HTML. Next 13b. |
