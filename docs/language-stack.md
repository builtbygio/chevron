...
**Status:** H2 PR 13 catalog + PR 13b stream. YAML and XML ported. This is the exception list, not a promise that first-mate dies.  
**Owner:** `builtbygio`  
...
|---------|-------|----------|
| `language-php` | builtbygio | High-traffic. Next 13b. |
