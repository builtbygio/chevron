...
| ~~cpm's registry client~~ **— removed 2026-08-28** | Installing packages the product does not ship. Gone with settings-view's Install and Updates panels; cpm keeps `rebuild`, `list`, `doctor`, `uninstall`, `link` |
