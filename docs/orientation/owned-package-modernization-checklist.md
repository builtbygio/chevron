...
- [ ] Remove dead deps; bump transitive SCA hotspots when you touch the package (see [sca-runtime-inventory.md](../reference/sca-runtime-inventory.md)).
...
- [package-ownership-inventory.md](../reference/package-ownership-inventory.md)  
- [package-node-policy.md](../reference/package-node-policy.md)  
- [cpm-prebuilds.md](./cpm-prebuilds.md)  
- [security-phase-s-decision.md](../decisions/security-phase-s-decision.md)  
