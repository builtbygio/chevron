...
- `react@18.3.1` + `react-dom@18.3.1` (8B first slice, `createRoot`) + `react-relay@5.0.0` + `relay-runtime@5.0.0` + `graphql@14.5.8` (artifacts only; no `graphql\` source to recompile)
