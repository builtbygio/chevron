...
**Related:** [REBRANDING.md](../decisions/REBRANDING.md), [package-ecosystem-strategy.md](../decisions/package-ecosystem-strategy.md), [chevron-architecture-modernization.md](./chevron-architecture-modernization.md), [security-phase-n.md](../process/security-phase-n.md), [security-phase-s-decision.md](../decisions/security-phase-s-decision.md)

This doc is **privilege and Node policy**, not a dual-product promise. Names and config home follow [REBRANDING.md](../decisions/REBRANDING.md).
...
"T2 is the host" is the direction of travel. It is **not** "install anything from Pulsar" — the catalog stays owned-only ([package-ecosystem-strategy.md](../decisions/package-ecosystem-strategy.md)). The host is the isolation model that has to exist *before* community install can reopen.
...
Use **cpm**. The `apm` name is retired. Prefer prebuilds for natives. See [cpm-cutover.md](../orientation/cpm-cutover.md) and [cpm-prebuilds.md](../orientation/cpm-prebuilds.md).
...
- Editor Chromium `sandbox` stays **false** under Phase S **Option C** until a later host/natives design says otherwise ([security-phase-s-decision.md](../decisions/security-phase-s-decision.md))
