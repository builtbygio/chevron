...
**Ecosystem strategy:** [package-ecosystem-strategy.md](../decisions/package-ecosystem-strategy.md) — **owned catalog only** until sandboxed community (host v2)  
**Modernization process:** [owned-package-modernization-checklist.md](../orientation/owned-package-modernization-checklist.md)  
...
- [owned-package-modernization-checklist.md](../orientation/owned-package-modernization-checklist.md)  
