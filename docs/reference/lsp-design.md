...
**Related:** [cpm-design.md](./cpm-design.md), [lsp-server-distribution.md](./lsp-server-distribution.md), [security-phase-s-package-host.md](./security-phase-s-package-host.md), [package-ecosystem-strategy.md](../decisions/package-ecosystem-strategy.md), [REBRANDING.md](../decisions/REBRANDING.md)  
...
- **Chevron-only API policy** ([REBRANDING.md](../decisions/REBRANDING.md), #83): new surfaces use
...
- **Closed owned catalog** ([package-ecosystem-strategy.md](../decisions/package-ecosystem-strategy.md), #83):
...
docs/reference/lsp-design.md                    # this file
docs/reference/lsp-server-distribution.md       # Phase 5 user install guide
```
