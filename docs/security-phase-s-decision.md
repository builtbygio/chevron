...
Related: [security-phase-s.md](./security-phase-s.md), [security-phase-s-package-host.md](./security-phase-s-package-host.md), [security-threat-model.md](./security-threat-model.md), `src/preload-natives.js`.
