...
**Status:** **complete** for N0–N5.1. Phase S is **done** as Option C ([security-phase-s-decision.md](../decisions/security-phase-s-decision.md)): editor `sandbox: false` is intentional. Bootstrap no longer applies `patch-github-remote.js` / `patch-packages-remote-ipc.js` (deleted #123).
**Depends on:** Phase R (remote removal) and Phase I (contextIsolation + preload boot) — both done.  
**Follows:** `docs/reference/remote-ipc-inventory.md` §4 / §9.  
**Handoff:** `GROK.md`
...
3. ~~Stop expanding package Node as a feature~~ **policy** ([package-node-policy.md](../reference/package-node-policy.md))  
...
- `docs/reference/remote-ipc-inventory.md` — Phase R/I history and IPC map
