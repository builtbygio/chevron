...
4. **New packages** should assume no Node long-term; use `atom.*` / IPC — see [package-node-policy.md](../reference/package-node-policy.md).
...
| Package author policy | [package-node-policy.md](../reference/package-node-policy.md) |
...
Full write-up: [package-node-policy.md](../reference/package-node-policy.md).
...
- `docs/process/security-phase-n2.md` — package shell / fs IPC  
- `docs/reference/remote-ipc-inventory.md` — historical remote kill list  
- `docs/process/security-phase-n.md` — full Phase N plan  
- `docs/reference/package-node-policy.md` — package author policy  
