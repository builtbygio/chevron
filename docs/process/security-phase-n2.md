...
- Phase N overview: `docs/process/security-phase-n.md` (when present) / `docs/reference/remote-ipc-inventory.md`
- IPC inventory: `docs/reference/remote-ipc-inventory.md` §9
