...
**Decision:** [security-phase-s-decision.md](../decisions/security-phase-s-decision.md) — editor `sandbox: false` permanent under current architecture  
**Depends on:** Phase N0–N5.1 (done), Electron BP P0–P3 shippable (done, 0.6.0)  
**Related:** [security-phase-s-package-host.md](../reference/security-phase-s-package-host.md), [security-phase-s-utilityprocess.md](./security-phase-s-utilityprocess.md), [security-threat-model.md](../reference/security-threat-model.md), [package-node-policy.md](../reference/package-node-policy.md)  
...
| `CHEVRON_ALLOW_PACKAGE_WORKER_BROWSERWINDOW=1` | **Ignored** (Node BW git workers removed) |
...
- Package host **v2** (utility process for community activation) — **deferred** until base Chevron is ready; product uses **owned catalog only** for now ([package-ecosystem-strategy.md](../decisions/package-ecosystem-strategy.md))  
