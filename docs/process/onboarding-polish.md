...
**Related:** [REBRANDING.md](../decisions/REBRANDING.md), [CHANGELOG.md](../../CHANGELOG.md)
...
- [x] `docs/decisions/REBRANDING.md` open item **Optional first-run config migrate prompt** is done **or** explicitly WONTFIX with a one-line reason here
...
| Topic | Where |
|-------|--------|
| cpm (done) | [cpm-cutover.md](../orientation/cpm-cutover.md), [cpm-design.md](../reference/cpm-design.md) |
