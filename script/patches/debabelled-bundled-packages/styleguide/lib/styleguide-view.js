...
var styleguide_view_exports = {};
__export(styleguide_view_exports, {
  default: () => StyleguideView
});
module.exports = __toCommonJS(styleguide_view_exports);
var import_etch = __toESM(require("etch"));
var import_dedent = __toESM(require("dedent"));
var import_code_block = __toESM(require("./code-block"));
var import_styleguide_section = __toESM(require("./styleguide-section"));
var import_example_select_list_view = __toESM(require("./example-select-list-view"));
class StyleguideView {
  constructor(props) {
    this.uri = props.uri;
    this.collapsedSections = props.collapsedSections ? new Set(props.collapsedSections) : /* @__PURE__ */ new Set();
    this.sections = [];
  ...
  render() {
    return /* @__PURE__ */ import_etch.default.dom("div", { className: "styleguide pane-item native-key-bindings", tabIndex: "-1" }, /* @__PURE__ */ import_etch.default.dom("header", { className: "styleguide-header" }, /* @__PURE__ */ import_etch.default.dom("h1", null, "Styleguide"), /* @__PURE__ */ import_etch.default.dom("p", null, "This exercises all UI components and acts as a styleguide."), /* @__PURE__ */ import_etch.default.dom("div", { className: "styleguide-controls btn-group" }, /* @__PURE__ */ import_etch.default.dom("button", { className: "btn", onclick: () => this.collapseAll() }, "Collapse All"), /* @__PURE__ */ import_etch.default.dom("button", { className: "btn", onclick: () => this.expandAll() }, "Expand All"))), /* @__PURE__ */ import_etch.default.dom("main", { className: "styleguide-sections" }, /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "variables", title: "Variables" }, /* @__PURE__ */ import_etch.default.dom("p", null, "Use these UI variables in your package's stylesheets. They are set by UI themes and therefore your package will match the overall look. Make sure to @import 'ui-variables' in your stylesheets to use these variables."), /* @__PURE__ */ import_etch.default.dom("h2", null, "Text colors"), this.renderExampleHTML(import_dedent.default`
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Background colors"), this.renderExampleHTML(import_dedent.default`
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Base colors"), this.renderExampleHTML(import_dedent.default`
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Component colors"), this.renderExampleHTML(import_dedent.default`
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Site colors"), this.renderExampleHTML(import_dedent.default`
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Sizes"), this.renderExampleHTML(import_dedent.default`
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Misc"), this.renderExampleHTML(import_dedent.default`
              <div class="is-radius component-border-radius">@component-border-radius</div>
              <div class="is-font font-family">@font-family</div>
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "icons", title: "Icons" }, /* @__PURE__ */ import_etch.default.dom("p", null, "Atom comes bundled with the Octicons. It lets you easily add icons to your packages."), /* @__PURE__ */ import_etch.default.dom("p", null, "Currently version ", /* @__PURE__ */ import_etch.default.dom("code", null, "4.4.0"), " is available. In addition some older icons from version ", /* @__PURE__ */ import_etch.default.dom("code", null, "2.1.2"), " are still kept for backwards compatibility. Make sure to use the ", /* @__PURE__ */ import_etch.default.dom("code", null, "icon icon-"), " prefix in front of an icon name. See the ", /* @__PURE__ */ import_etch.default.dom("a", { href: "http://flight-manual.atom.io/hacking-atom/sections/iconography/" }, "documentation"), " for more details."), /* @__PURE__ */ import_etch.default.dom("h2", null, "Octicons"), this.renderExampleHTML(import_dedent.default`
            ...
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "inputs", title: "Inputs" }, /* @__PURE__ */ import_etch.default.dom("p", null, "Various inputs and controls."), /* @__PURE__ */ import_etch.default.dom("h2", null, "Text Inputs"), this.renderExampleHTML(import_dedent.default`
              <input class='input-text' type='text' placeholder='Text'>
              <input class='input-search' type='search' placeholder='Search'>
              <textarea class='input-textarea' placeholder='Text Area'></textarea>
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Controls"), this.renderExampleHTML(import_dedent.default`
            ...
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "text", title: "Text" }, /* @__PURE__ */ import_etch.default.dom("p", null, "There are a number of text classes."), /* @__PURE__ */ import_etch.default.dom("h2", null, "text-* classes"), this.renderExampleHTML(import_dedent.default`
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "highlight-* classes"), this.renderExampleHTML(import_dedent.default`
            ...
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "layout", title: "Layout" }, /* @__PURE__ */ import_etch.default.dom("p", null, "A few things that might be useful for general layout."), /* @__PURE__ */ import_etch.default.dom("h2", null, ".block"), /* @__PURE__ */ import_etch.default.dom("p", null, "Sometimes you need to separate components vertically. Say in a form."), this.renderExampleHTML(import_dedent.default`
              <div class='block'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, ".inline-block"), /* @__PURE__ */ import_etch.default.dom("p", null, "Sometimes you need to separate components horizontally."), this.renderExampleHTML(import_dedent.default`
              <div class='block'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, ".inline-block-tight"), /* @__PURE__ */ import_etch.default.dom("p", null, "You might want things to be a little closer to each other."), this.renderExampleHTML(import_dedent.default`
              <div class='block'>
            ...
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "git", title: "Git Status" }, /* @__PURE__ */ import_etch.default.dom("p", null, "Often we need git related classes to specify status."), /* @__PURE__ */ import_etch.default.dom("h2", null, "status-* classes"), this.renderExampleHTML(import_dedent.default`
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "status-* classes with related icons"), this.renderExampleHTML(import_dedent.default`
            ...
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "site-highlight", title: "Site colors" }, /* @__PURE__ */ import_etch.default.dom("p", null, "Site colors are used for collaboration. A site is another collaborator."), /* @__PURE__ */ import_etch.default.dom("h2", null, "ui-site-* classes"), /* @__PURE__ */ import_etch.default.dom("p", null, "These classes only set the background color, no other styles. You can also use LESS variables ", /* @__PURE__ */ import_etch.default.dom("code", null, "@ui-site-#"), " in your plugins where", /* @__PURE__ */ import_etch.default.dom("code", null, "#"), " is a number between 1 and 5."), /* @__PURE__ */ import_etch.default.dom("p", null, "Site colors will always be in the color progression you see here."), this.renderExampleHTML(import_dedent.default`
            ...
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "badges", title: "Badges" }, /* @__PURE__ */ import_etch.default.dom("p", null, "Badges are typically used to show numbers."), /* @__PURE__ */ import_etch.default.dom("h2", null, "Standalone badges"), this.renderExampleHTML(import_dedent.default`
              <div class='block'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Colored badges"), this.renderExampleHTML(import_dedent.default`
              <div class='block'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Badge sizes"), /* @__PURE__ */ import_etch.default.dom("p", null, "By default the ", /* @__PURE__ */ import_etch.default.dom("code", null, "@font-size"), " variable from themes is used. Additionally there are also 3 predefined sizes."), this.renderExampleHTML(import_dedent.default`
            ...
            `), /* @__PURE__ */ import_etch.default.dom("p", null, "If you like the size change depending on the parent, use the ", /* @__PURE__ */ import_etch.default.dom("code", null, "badge-flexible"), " class. Note: Best used for larger sizes. For smaller sizes it could cause the number to be mis-aligned by a pixel."), this.renderExampleHTML(import_dedent.default`
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Icon Badges"), /* @__PURE__ */ import_etch.default.dom("p", null, "See the icons section to get an overview of all Octicons."), this.renderExampleHTML(import_dedent.default`
              <div class='block'>
            ...
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "buttons", title: "Buttons" }, /* @__PURE__ */ import_etch.default.dom("p", null, "Buttons are similar to bootstrap buttons"), /* @__PURE__ */ import_etch.default.dom("h2", null, "Standalone buttons"), this.renderExampleHTML(import_dedent.default`
              <div class='block'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Colored buttons"), this.renderExampleHTML(import_dedent.default`
              <div class='block'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Icon buttons"), /* @__PURE__ */ import_etch.default.dom("p", null, "Overview of all ", /* @__PURE__ */ import_etch.default.dom("a", { href: "https://octicons.github.com/" }, "Octicons"), "."), this.renderExampleHTML(import_dedent.default`
              <div class='block'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Button Groups"), this.renderExampleHTML(import_dedent.default`
              <div class='block'>
                <div>Normal size</div>
                <div class='btn-group'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Button Toolbars"), this.renderExampleHTML(import_dedent.default`
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Selected buttons"), /* @__PURE__ */ import_etch.default.dom("p", null, "Buttons can be marked selected by adding a ", /* @__PURE__ */ import_etch.default.dom("code", null, ".selected"), " class. Useful for toggle groups."), this.renderExampleHTML(import_dedent.default`
              <div class='block'>
                <div class='btn-group'>
            ...
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "panel", title: "Panels" }, /* @__PURE__ */ import_etch.default.dom("p", null, "A container attached to some side of the Atom UI."), this.renderExampleHTML(import_dedent.default`
              <atom-panel>
                Some content
              </atom-panel>
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Inset Panel"), /* @__PURE__ */ import_etch.default.dom("p", null, "Use inside a panel"), this.renderExampleHTML(import_dedent.default`
              <atom-panel class='padded'>
                <div class="inset-panel padded">Some inset content</div>
              </atom-panel>
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "With a heading"), this.renderExampleHTML(import_dedent.default`
              <atom-panel class='padded'>
            ...
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "list-group", title: "List Group" }, /* @__PURE__ */ import_etch.default.dom("p", null, "Use for anything that requires a list."), this.renderExampleHTML(import_dedent.default`
              <ul class='list-group'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "With icons"), this.renderExampleHTML(import_dedent.default`
              <ul class='list-group'>
                <li class='list-item'>
            ...
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "list-tree", title: "List Tree" }, /* @__PURE__ */ import_etch.default.dom("p", null, "A ", /* @__PURE__ */ import_etch.default.dom("code", null, ".list-tree"), " is a special case of ", /* @__PURE__ */ import_etch.default.dom("code", null, ".list-group"), "."), this.renderExampleHTML(import_dedent.default`
              <ul class='list-tree'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "With disclosure arrows"), /* @__PURE__ */ import_etch.default.dom("p", null, "Add the class ", /* @__PURE__ */ import_etch.default.dom("code", null, ".has-collapsable-children"), " to give the children with nested items disclosure arrows."), this.renderExampleHTML(import_dedent.default`
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "With disclosure arrows at only one level."), /* @__PURE__ */ import_etch.default.dom("p", null, "Add the class ", /* @__PURE__ */ import_etch.default.dom("code", null, ".has-flat-children"), " to sub-", /* @__PURE__ */ import_etch.default.dom("code", null, ".list-tree"), "s to indicate that the children will not be collapsable."), this.renderExampleHTML(import_dedent.default`
              <ul class='list-tree has-collapsable-children '>
                <li class='list-nested-item'>
                  <div class='list-item'>
            ...
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "select-list", title: "Select List" }, /* @__PURE__ */ import_etch.default.dom("p", null, "This is how you will typically specify a ", /* @__PURE__ */ import_etch.default.dom("code", null, ".select-list"), "."), /* @__PURE__ */ import_etch.default.dom(import_example_select_list_view.default, null), /* @__PURE__ */ import_etch.default.dom("p", null, "The list items have many options you can use, and shows you how they will display."), /* @__PURE__ */ import_etch.default.dom("h2", null, "Basic example with one item selected"), this.renderExampleHTML(import_dedent.default`
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Single line with icons"), this.renderExampleHTML(import_dedent.default`
              <atom-panel class='modal'>
                <div class='select-list'>
                  <ol class='list-group'>
                    <li class='selected'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Single line with key-bindings"), this.renderExampleHTML(import_dedent.default`
              <atom-panel class='modal'>
                <div class='select-list'>
                  <ol class='list-group'>
                    <li class='selected'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Multiple lines with no icons"), this.renderExampleHTML(import_dedent.default`
              <atom-panel class='modal'>
                <div class='select-list'>
                  <ol class='list-group'>
                    <li class='two-lines'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Multiple lines with icons"), this.renderExampleHTML(import_dedent.default`
              <atom-panel class='modal'>
                <div class='select-list'>
                  <ol class='list-group'>
                    <li class='two-lines'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Using mark-active class to indicate the active item"), /* @__PURE__ */ import_etch.default.dom("p", null, "Use ..."), this.renderExampleHTML(import_dedent.default`
              <atom-panel class='modal'>
                <div class='select-list'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Error messages"), this.renderExampleHTML(import_dedent.default`
              <atom-panel class='modal'>
                <div class='select-list'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Loading message"), this.renderExampleHTML(import_dedent.default`
              <atom-panel class='modal'>
                <div class='select-list'>
            ...
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "popover-list", title: "Popover List" }, /* @__PURE__ */ import_etch.default.dom("p", null, "A ", /* @__PURE__ */ import_etch.default.dom("code", null, ".popover-list"), " is a ", /* @__PURE__ */ import_etch.default.dom("code", null, ".select-list"), " that is meant to popover the code for something like autocomplete."), /* @__PURE__ */ import_etch.default.dom("h2", null, "Basic example with one item selected"), this.renderExampleHTML(import_dedent.default`
            ...
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "modal-panel", title: "Modals" }, /* @__PURE__ */ import_etch.default.dom("p", null, "Modals are like dialog boxes."), this.renderExampleHTML(import_dedent.default`
              <atom-panel class='modal'>
                <div>Some content</div>
              </atom-panel>
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "tooltips", title: "Tooltips" }, /* @__PURE__ */ import_etch.default.dom("p", null, "You do not create the markup directly. You call", /* @__PURE__ */ import_etch.default.dom("code", null, `element.setTooltip(title, {command, commandElement}={})`), ". Passing in a ", /* @__PURE__ */ import_etch.default.dom("code", null, "command"), " (like ", /* @__PURE__ */ import_etch.default.dom("code", null, "find-and-replace:show-find"), ") and", /* @__PURE__ */ import_etch.default.dom("code", null, "commandElement"), " (context for the command) will yield a tip with a keystroke."), this.renderExampleHTML(import_dedent.default`
            ...
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "error-messages", title: "Messages" }, /* @__PURE__ */ import_etch.default.dom("p", null, "Use to convey info to the user when something happens. See ", /* @__PURE__ */ import_etch.default.dom("code", null, "find-and-replace"), "for an example."), /* @__PURE__ */ import_etch.default.dom("h2", null, "Error messages"), this.renderExampleHTML(import_dedent.default`
              <ul class='error-messages block'>
                <li>This is an error!</li>
                <li>And another</li>
              </ul>
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Info messages"), this.renderExampleHTML(import_dedent.default`
              <ul class='info-messages block'>
                <li>Info line</li>
                <li>Another info line</li>
              </ul>
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Background Messages"), /* @__PURE__ */ import_etch.default.dom("p", null, "Subtle background messages for panes. Use for cases when there are no results."), this.renderExampleHTML(import_dedent.default`
              <ul class='background-message'>
                <li>No Results</li>
              </ul>
            `), /* @__PURE__ */ import_etch.default.dom("p", null, "Centered background messages will center horizontally and vertically. Your container for this element must have ", /* @__PURE__ */ import_etch.default.dom("code", null, "position"), " set with ", /* @__PURE__ */ import_etch.default.dom("code", null, "relative"), " or", /* @__PURE__ */ import_etch.default.dom("code", null, "absolute"), "."), this.renderExampleHTML(import_dedent.default`
              <ul class='background-message centered'>
                <li>No Results</li>
              </ul>
            `)), /* @__PURE__ */ import_etch.default.dom(import_styleguide_section.default, { onDidInitialize: this.didInitializeSection.bind(this), name: "progress", title: "Loading/Progress" }, /* @__PURE__ */ import_etch.default.dom("h2", null, "Progress Bars"), this.renderExampleHTML(import_dedent.default`
              <div class='block'>
            ...
            `), /* @__PURE__ */ import_etch.default.dom("h2", null, "Loading Spinners"), this.renderExampleHTML(import_dedent.default`
  ...
  renderExampleHTML(html) {
    return /* @__PURE__ */ import_etch.default.dom("div", { className: "example" }, /* @__PURE__ */ import_etch.default.dom("div", { className: "example-rendered", innerHTML: html }), /* @__PURE__ */ import_etch.default.dom("div", { className: "example-code show-example-html" }, /* @__PURE__ */ import_etch.default.dom(import_code_block.default, { cssClass: "example-html", grammarScopeName: "text.html.basic", code: html })));
  }
