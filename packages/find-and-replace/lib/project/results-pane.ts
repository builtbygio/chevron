...
class ResultsPaneView {
  constructor() {
    ...
    this.subscriptions = new CompositeDisposable(
      ...
      chevron.config.observe('find-and-replace.searchContextLineCountBefore', this.searchContextLineCountChanged.bind(this)),
      chevron.config.observe('find-and-replace.searchContextLineCountAfter', this.searchContextLineCountChanged.bind(this))
    );
  }
  ...
  searchContextLineCountChanged() {
    this.searchContextLineCountBefore = chevron.config.get('find-and-replace.searchContextLineCountBefore');
    this.searchContextLineCountAfter = chevron.config.get('find-and-replace.searchContextLineCountAfter');
...
module.exports.URI = "chevron://find-and-replace/project-results";
