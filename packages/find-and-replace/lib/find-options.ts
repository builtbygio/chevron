...
(FindOptions = class FindOptions {
  constructor(state) {
    ...
    this.useRegex = (left = state.useRegex != null ? state.useRegex : chevron.config.get('find-and-replace.useRegex')) != null ? left : false;
    this.caseSensitive = (left1 = state.caseSensitive != null ? state.caseSensitive : chevron.config.get('find-and-replace.caseSensitive')) != null ? left1 : false;
    this.wholeWord = (left2 = state.wholeWord != null ? state.wholeWord : chevron.config.get('find-and-replace.wholeWord')) != null ? left2 : false;
    this.inCurrentSelection = (left3 = state.inCurrentSelection != null ? state.inCurrentSelection : chevron.config.get('find-and-replace.inCurrentSelection')) != null ? left3 : false;
    this.leadingContextLineCount = (left4 = state.leadingContextLineCount != null ? state.leadingContextLineCount : chevron.config.get('find-and-replace.leadingContextLineCount')) != null ? left4 : 0;
    this.trailingContextLineCount = (left5 = state.trailingContextLineCount != null ? state.trailingContextLineCount : chevron.config.get('find-and-replace.trailingContextLineCount')) != null ? left5 : 0;
  }
  ...
  set(newParams) {
    ...
    let changedParams = {};
    for (var key of Array.from(Params)) {
