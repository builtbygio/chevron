...
class MatchManager {
  ...
  getScopedSetting (key) {
    return chevron.config.get(key, {scope: this.editor.getRootScopeDescriptor()})
  }
  ...
  constructor (editor, editorElement) {
    ...
    this.subscriptions.add(
      chevron.config.observe('bracket-matcher.autocompleteCharacters', {scope}, () => this.updateConfig()),
      chevron.config.observe('bracket-matcher.pairsWithExtraNewline', {scope}, () => this.updateConfig()),
