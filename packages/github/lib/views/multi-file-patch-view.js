...
class MultiFilePatchView extends _react.default.Component {
      ...
      this.refEditor.map(editor => {
        ...
        if (lastSelectionIndex !== null) {
          ...
          if (this.props.selectionMode === 'line') {
            ...
            const nextHunks = new Set(_chevron.Range.fromObject(nextSelectionRange).getRows().map(row => nextPatch.getHunkAt(row)).filter(Boolean));
            /* istanbul ignore next */
  ...
  renderCommands() {
    ...
    /* istanbul ignore next */
    chevron.inDevMode() && _react.default.createElement(_commands.Command, {
  ...
  renderNonEmptyPatch() {
    return _react.default.createElement(_atomTextEditor.default, {
      ...
      onMouseDown: this.didMouseDownOnLineNumber,
      onMouseMove: this.didMouseMoveOnLineNumber
    }), this.renderPRCommentIcons(), this.props.multiFilePatch.getFilePatches().map(this.renderFilePatchDecorations), this.renderLineDecorations(Array.from(this.props.selectedRows, row => _chevron.Range.fromObject([[row, 0], [row, Infinity]])), 'github-FilePatchView-line--selected', {
      gutter: true,
      icon: true,
      line: true
  ...
  renderHunkHeaders(filePatch, orderOffset) {
    ...
    return _react.default.createElement(_react.Fragment, null, _react.default.createElement(_markerLayer.default, null, filePatch.getHunks().map((hunk, index) => {
      ...
      const startRange = new _chevron.Range(startPoint, startPoint);
      return _react.default.createElement(_marker.default, {
  ...
  handleSelectionEvent(event, rangeLike, opts) {
    ...
    const converted = _chevron.Range.fromObject(rangeLike);
