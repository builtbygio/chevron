...
var _repositoryHomeSelectionView = require("./repository-home-selection-view");
...
class CreateDialogView extends _react.default.Component {
  ...
  render() {
    ...
    }, _react.default.createElement(_repositoryHomeSelectionView.BareRepositoryHomeSelectionView, {
      relay: this.props.orgRelay || (0, _relayStub.createRelayStub)(),
      tabGroup: this.tabGroup,
      commands: this.props.commands,
      autofocusName: true,
