...
class MarkerSpan extends _react.default.Component {
  ...
  handleMouseOver(e) {
    ...
    (0, _reactRoot.render)(_react.default.createElement(MarkerTooltip, {
      marker: this.props.marker
    }), elem);
    this._tooltipNode = elem;

    this.tooltipDisposable = chevron.tooltips.add(this.element, {
      item: elem,
  ...
  closeTooltip() {
    ...
    if (this._tooltipNode) {
      (0, _reactRoot.unmount)(this._tooltipNode);
...
class WaterfallWidget extends _react.default.Component {
  ...
  async handleExportClick(e) {
    ...
    const buffer = new _chevron.TextBuffer({
      text: json
    });
    const {
      filePath
...
class GitTimingsView extends _react.default.Component {
  ...
  async handleImportClick(e) {
    ...
    try {
      ...
      chevron.notifications.addError(`Could not import timings from ${filename}`);
    }
  }
