...
var _issueishTimelineView = _interopRequireDefault(require("./issueish-timeline-view"));

var _emojiReactionsController = require("../controllers/emoji-reactions-controller");
...
class BarePullRequestDetailView extends _react.default.Component {
  ...
  renderPullRequestBody(pullRequest) {
    ...
    }), _react.default.createElement(_emojiReactionsController.BareEmojiReactionsController, {
    ...
    }), _react.default.createElement(_issueishTimelineView.default, {
      relay: this.props.timelineRelay || this.props.relay,
      onBranch: onBranch,
    ...
    }, _react.default.createElement(_prStatusesView.BarePrStatusesView, {
      relay: this.props.relay,
      pullRequest: pullRequest,
      displayType: "full",
      switchToIssueish: this.props.switchToIssueish
    }))), _react.default.createElement(_reactTabs.TabPanel, null, _react.default.createElement(_prCommitsView.PrCommitsView, {
      relay: this.props.commitsRelay || this.props.relay,
      pullRequest: pullRequest,
      onBranch: onBranch,
      openCommit: this.props.openCommit
...
exports.default = BarePullRequestDetailView;