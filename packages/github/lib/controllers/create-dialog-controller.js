...
class BareCreateDialogController extends _react.default.Component {
  constructor(props) {
    ...
    this.repoName = new _chevron.TextBuffer({
      text: localDir ? _path.default.basename(localDir) : ''
    });
    this.localPath = new _chevron.TextBuffer({
      text: localDir || this.projectHome
    });
    this.sourceRemoteName = new _chevron.TextBuffer({
...
exports.default = BareCreateDialogController;