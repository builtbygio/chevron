...
class BareIssueishDetailController extends _react.default.Component {
  ...
  render() {
    ...
    if (this.getTypename() === 'PullRequest') {
      ...
      }, checkoutOp => _react.default.createElement(_prDetailView.BarePullRequestDetailView, {
        relay: this.props.relay,
        timelineRelay: this.props.timelineRelay || this.props.relay,
        commitsRelay: this.props.commitsRelay || this.props.relay,
      ...
      return _react.default.createElement(_issueDetailView.BareIssueDetailView, {
        relay: this.props.relay,
        timelineRelay: this.props.timelineRelay || this.props.relay,
        endpoint: this.props.endpoint,
        token: this.props.token,
...
exports.default = BareIssueishDetailController;