...
class BareReviewsController extends _react.default.Component {
  constructor(props) {
    ...
    _defineProperty(this, "afterMutate", () => {
    ...
    _defineProperty(this, "resolveThread", async thread => {
      if (thread.viewerCanResolve) {
        ...
        try {
          await (0, _resolveReviewThread.default)(this.graphqlAuth(), {
            threadID: thread.id
          });
          this.afterMutate();
    ...
    _defineProperty(this, "unresolveThread", async thread => {
      if (thread.viewerCanUnresolve) {
        try {
          await (0, _unresolveReviewThread.default)(this.graphqlAuth(), {
            threadID: thread.id
          });
          this.afterMutate();
          this.highlightThread(thread.id);
    ...
    _defineProperty(this, "addSingleComment", async (commentBody, threadID, replyToID, commentPath, position, callbacks = {}) => {
      ...
      try {
        ...
        const reviewResult = await (0, _addPrReview.default)(this.graphqlAuth(), {
          pullRequestID: this.props.pullRequest.id
        });
        const reviewID = reviewResult.addPullRequestReview.reviewEdge.node.id;
        pendingReviewID = reviewID;
        const commentPromise = (0, _addPrReviewComment.default)(this.graphqlAuth(), {
          body: commentBody,
          inReplyTo: replyToID,
          reviewID
        });
        ...
        await (0, _submitPrReview.default)(this.graphqlAuth(), {
          event: 'COMMENT',
          reviewID
        });
        this.afterMutate();
        ...
        if (pendingReviewID !== null) {
          try {
            await (0, _deletePrReview.default)(this.graphqlAuth(), {
    ...
    _defineProperty(this, "updateComment", async (commentId, commentBody) => {
      try {
        await (0, _updatePrReviewComment.default)(this.graphqlAuth(), {
          commentId,
          commentBody
        });
        this.afterMutate();
    ...
    _defineProperty(this, "updateSummary", async (reviewId, reviewBody) => {
      try {
        await (0, _updatePrReviewSummary.default)(this.graphqlAuth(), {
          reviewId,
          reviewBody
        });
        this.afterMutate();
  ...
  render() {
    return _react.default.createElement(_prCheckoutController.BarePullRequestCheckoutController, {
...
_defineProperty(BareReviewsController, "propTypes", {
  // Relay results
  relay: _propTypes.default.object,
...
exports.default = BareReviewsController;