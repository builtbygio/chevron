...
class Patch {
  ...
  getStartRange() {
    ...
    return _chevron.Range.fromObject([startPoint, startPoint]);
  }
  ...
  getFirstChangeRange() {
    ...
    if (!firstHunk) {
      return _chevron.Range.fromObject([[0, 0], [0, 0]]);
    }
    ...
    return _chevron.Range.fromObject([[firstRow, 0], [firstRow, Infinity]]);
  }
