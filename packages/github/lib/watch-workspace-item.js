...
class ItemWatcher {
  constructor(workspace, pattern, component, stateKey) {
    ...
    this.subs = new _chevron.CompositeDisposable();
  }
  ...
  subscribeToWorkspace() {
    this.subs.dispose();
    this.subs = new _chevron.CompositeDisposable(this.workspace.getCenter().onDidChangeActivePaneItem(this.updateActiveState));
    return this;
  }
