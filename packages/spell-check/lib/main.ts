...
module.exports = {
    activate() {
        if (chevron.config.get('spell-check.enableDebug')) {
            debug = require('debug');
        ...
        this.globalArgs = {
            ...
            locales: chevron.config.get('spell-check.locales'),
            localePaths: chevron.config.get('spell-check.localePaths'),
            useSystem: chevron.config.get('spell-check.useSystem'),
            useLocales: chevron.config.get('spell-check.useLocales'),
            knownWords: chevron.config.get('spell-check.knownWords'),
            addKnownWords: chevron.config.get('spell-check.addKnownWords'),
    ...
    toggle() {
        if (!chevron.workspace.getActiveTextEditor()) {
            return;
        }
        const editorId = chevron.workspace.getActiveTextEditor().id;
