...
class ImageEditorView {
  constructor (editor) {
    ...
    this.refs.image.onload = () => {
      ...
      this.defaultBackgroundColor = chevron.config.get('image-view.defaultBackgroundColor')
      this.refs.imageContainer.setAttribute('background', this.defaultBackgroundColor)
      this.emitter.emit('did-load')
    }

    this.disposables.add(chevron.tooltips.add(this.refs.whiteTransparentBackgroundButton, {title: 'Use white transparent background'}))
    this.disposables.add(chevron.tooltips.add(this.refs.blackTransparentBackgroundButton, {title: 'Use black transparent background'}))
    this.disposables.add(chevron.tooltips.add(this.refs.transparentTransparentBackgroundButton, {title: 'Use transparent background'}))
