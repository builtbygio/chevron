...
class WindowPanelView {
  constructor() {
    ...
    this.disposables.add(chevron.tooltips.add(this.refs.shellTiming, { title: "The time taken to launch the app" }));
    this.disposables.add(chevron.tooltips.add(this.refs.windowTiming, { title: "The time taken to load this window" }));
    this.disposables.add(chevron.tooltips.add(this.refs.projectTiming, { title: "The time taken to rebuild the previously opened buffers" }));
    this.disposables.add(chevron.tooltips.add(this.refs.workspaceTiming, { title: "The time taken to rebuild the previously opened editors" }));
  }
  update() {
  }
  destroy() {
  ...
  populate() {
    ...
    if (chevron.deserializeTimings.project != null) {
      this.refs.projectLoadTime.classList.add(this.getHighlightClass(chevron.deserializeTimings.project));
      this.refs.projectLoadTime.textContent = `${chevron.deserializeTimings.project}ms`;
      this.refs.workspaceLoadTime.classList.add(this.getHighlightClass(chevron.deserializeTimings.workspace));
      this.refs.workspaceLoadTime.textContent = `${chevron.deserializeTimings.workspace}ms`;
    } else {
